...
<body>
  ...
  <div class="container pb-5">
    ...
    <div class="row mb-5">
      <div class="col-12">
        <div class="card border-0 rounded-4 exam-card p-4 p-md-5">
          <div class="d-flex align-items-center mb-4 border-bottom pb-3" style="border-color: var(--border-soft) !important;">
            <div class="rounded-3 d-flex align-items-center justify-content-center me-3" style="width: 45px; height: 45px; background: var(--answered-bg); color: var(--c-1);">
              <i class="bi bi-person-vcard fs-4"></i>
            </div>
            <h4 class="fw-bolder mb-0" style="color: var(--text-main);">Kartu Peserta Ujian</h4>
          </div>
          <div class="row align-items-center">
            <div class="col-md-2 text-center mb-4 mb-md-0">
              <div class="rounded-4 mx-auto d-flex align-items-center justify-content-center" style="width: 130px; height: 150px; background: var(--bg-body); border: 2px dashed var(--border-soft);">
                <i class="bi bi-person-fill" style="font-size: 6rem; color: var(--border-hard);"></i>
              </div>
            </div>
            <div class="col-md-10">
              <div class="table-responsive">
                <table class="table table-borderless mb-0">
                  <tbody>
                    <tr>
                      <td width="30%" class="py-1" style="color: var(--text-muted); font-weight: 500;">Nama Lengkap</td>
                      <td width="2%" class="py-1">:</td>
                      <td class="py-1 fw-bold fs-5" style="color: var(--text-main);">{{ $student->name }}</td>
                    </tr>
                    <tr>
                      <td class="py-1" style="color: var(--text-muted); font-weight: 500;">Username Ujian</td>
                      <td class="py-1">:</td>
                      <td class="py-1 fw-bold font-monospace" style="color: var(--c-1); font-size: 1.1rem;">{{ Auth::guard('cbt')->user()->username }}</td>
                    </tr>
                    <tr>
                      <td class="py-1" style="color: var(--text-muted); font-weight: 500;">Tempat, Tanggal Lahir</td>
                      <td class="py-1">:</td>
                      <td class="py-1 fw-bold" style="color: var(--text-main);">{{ $student->birth_place ?? '-' }}, {{ $student->birth_date ? \Carbon\Carbon::parse($student->birth_date)->locale('id')->translatedFormat('d F Y') : '-' }}</td>
                    </tr>
                    <tr>
                      <td class="py-1" style="color: var(--text-muted); font-weight: 500;">Kelas / Rombel</td>
                      <td class="py-1">:</td>
                      <td class="py-1 fw-bold" style="color: var(--text-main);">{{ $student->class_group ?? $student->level ?? 'Siswa Reguler' }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
  ...
  <script>
    ...
    Swal.fire({
      ...
      , customClass: {
        popup: 'rounded-4'
        , confirmButton: 'btn btn-primary-custom rounded-pill px-4'
      }
