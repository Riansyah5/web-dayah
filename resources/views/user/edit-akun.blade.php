...
@push('link')
  ...
  @push('styles')
    <style>
      ...
      /* Input Styling */
      #tambah-akun-page .form-control,
      #tambah-akun-page .form-select {
      ...
      #tambah-akun-page .form-control:focus,
      #tambah-akun-page .form-select:focus {
        ...
        <div class="col-md-6 col-lg-5">
          ...
          <div class="mb-3">
            <a href="{{ route('user.index') }}"
              class="text-decoration-none btn btn-sm btn-outline-secondary rounded fw-medium">
              ...
              <form id="form-tambah-akun" method="POST" action="{{ route('user.update', $user->id) }}">
                ...
                <div class="mb-4 bg-light p-3 rounded-3 d-flex align-items-center justify-content-between">
                  ...
                  <div class="form-check form-switch d-flex align-items-center">
                    ...
                    <input class="form-check-input mt-0" type="checkbox" role="switch" id="statusSwitch" name="status"
                      value="Aktif" {{ old('status', $user->status) == 'Aktif' ? 'checked' : '' }}>
                    <span class="status-text {{ $user->status == 'Aktif' ? 'text-success' : 'text-danger' }}"
                      id="statusLabel">{{ $user->status }}</span>
                  </div>
                </div>
