  ...
  @push('styles')
    <style>
      body {
        ...
        /* Abu-abu sangat muda agar kartu menonjol */
        color: #495057;
      }
      ...
      .avatar {
        ...
        object-fit: cover;
        border-radius: 12px;
        /* Rounded square lebih modern drpd circle */
      }
    ...
    <div class="container py-5">
      ...
      <div class="card card-modern mb-4">
        <div class="card-body p-3">
          <div class="row g-3">
            <div class="col-md-4">
              <input type="text" id="searchInput" class="form-control search-input py-2"
              ...
              <tbody id="userTableBody">
                @foreach ($users as $user)
                  ...
                  <tr class="user-row" data-role="{{ $user->role }}"
                    ...
                    <td>
                      <div class="{{ $user->status == 'Aktif' ? 'badge-soft-success' : 'badge-soft-danger' }}"
                        id="badgeStatus{{ $user->id }}">
                ...
                <tr class="user-row" data-role="editor" data-status="inactive">
                  <td class="ps-4">
                    <div class="d-flex align-items-center">
                      <img src="https://ui-avatars.com/api/?name=John+Wick&background=0D8ABC&color=fff" alt="Avatar"
                        class="avatar me-3 shadow-sm">
                      <div>
                  ...
                  <td><span class="badge bg-light text-dark border fw-normal"><i class="bi bi-pencil me-1"></i>
                      Editor</span></td>
                  <td><span class="badge-soft-danger fw-normal">Inactive</span></td>
                  <td class="text-muted">12 Oct, 2023</td>
                  <td class="text-end pe-4">
                    <a href="#" class="btn btn-icon btn-light text-primary me-2"><i
                ...
                <tr class="user-row" data-role="viewer" data-status="active">
                  <td class="ps-4">
                    <div class="d-flex align-items-center">
                      <img src="https://ui-avatars.com/api/?name=Bruce+Wayne&background=333&color=fff" alt="Avatar"
                        class="avatar me-3 shadow-sm">
                      <div>
                  ...
                  <td><span class="badge bg-light text-dark border fw-normal"><i class="bi bi-person me-1"></i>
                      Viewer</span></td>
          ...
          <div class="d-flex justify-content-between align-items-center px-4 py-3 border-top">
            ...
            <nav>
              <ul class="pagination pagination-sm mb-0">
                ...
                <li class="page-item"><a class="page-link border-0 bg-primary text-white rounded shadow-sm"
                    href="#">1</a></li>
