      ...
      <div class="card shadow-sm border-0 profile-card sticky-top" style="top: 1.5rem;">
        <div class="card-body p-4 text-center">
          <div class="avatar-wrapper mb-4">
            <img src="https://ui-avatars.com/api/?name={{ urlencode($pegawai->nama) }}&background=4f46e5&color=fff&size=128" alt="Avatar" class="rounded-circle" width="110" height="110">
          </div>
        ...
        <div class="card-body p-4 p-md-5">
          ...
          <div class="row g-3 px-2">
            ...
            <div class="col-sm-6">
              ...
              <dd>{{ $pegawai->tempat_lahir }}, {{ $pegawai->tanggal_lahir->locale('id')->translatedFormat('d F Y') }}
                <span class="text-success">({{ $pegawai->tanggal_lahir->age }} Tahun)</span></dd>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              ...
              <dd>
                @if($pegawai->no_hp)
                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $pegawai->no_hp) }}" target="_blank" class="text-decoration-none text-dark">
                  <i class="fab fa-whatsapp text-success me-1"></i>{{ preg_replace('/(\d{2})(\d{3})(\d{4})(\d+)/', '$1 $2 $3 $4', $pegawai->no_hp) }}
                </a>
                @else
                -
                @endif
