                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik"
                      name="nik" value="{{ old('nik') }}" placeholder="Contoh: 3201..." maxlength="16" required>
                    @error('nik')
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control @error('no_kk') is-invalid @enderror" id="no_kk"
                      name="no_kk" value="{{ old('no_kk') }}" placeholder="16 digit No. KK" maxlength="16">
                    @error('no_kk')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp"
                      name="no_hp" value="{{ old('no_hp') }}" placeholder="mis: 081234567890" maxlength="16">
                    @error('no_hp')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <select class="form-select @error('kategori_pegawai') is-invalid @enderror" id="kategori_pegawai"
                    ...
                    @foreach ($kategoris as $kategori)
                      <option value="{{ $kategori->name }}"
                        {{ old('kategori_pegawai') == $kategori->name ? 'selected' : '' }}>
                        {{ $kategori->name }}
                      </option>
                    @endforeach
                  </select>
