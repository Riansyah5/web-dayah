        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4">
          <div class="list-group list-group-flush rounded-4">
            ...
            <div class="list-group-item p-3">
              ...
              <input type="text" name="note[{{ $student->id }}]" class="form-control form-control-sm" placeholder="Keterangan..." value="{{ $note }}" style="max-width: 200px;">
            </div> --}}
            ...
            <div class="d-flex flex-column align-items-end gap-2">
              <div class="btn-group w-100" role="group">
                ...
                <label class="btn btn-outline-secondary" for="t_{{ $student->id }}" title="Terlambat">T</label>
              ...
              <input type="text" name="note[{{ $student->id }}]" class="form-control form-control-sm" placeholder="Ket..." value="{{ $note }}">
            </div>
