  ...
  <div class="card border-0 shadow-sm rounded-4 mb-4 bg-info text-white overflow-hidden position-relative">
    ...
    <div class="card-body p-4 position-relative z-1">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('classrooms.index') }}" class="btn btn-sm btn-light bg-secondary bg-opacity-55 text-white border-0 rounded-pill px-3">
      ...
      <div class="card border-0 shadow-sm rounded-4 h-100">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
          ...
          <div class="dropdown d-inline-block">
            <button class="btn btn-sm btn-danger dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="bi bi-printer me-2"></i> Menu Cetak
            </button>
            <ul class="dropdown-menu shadow" aria-labelledby="dropdownMenuButton">
              <li>
                <a class="dropdown-item" href="{{ route('classrooms.print-attendance', $classroom->id) }}" target="_blank">
                  <i class="bi bi-file-pdf me-2 text-danger"></i> Cetak Absen Kelas
                </a>
              </li>

              <li>
                <a class="dropdown-item" href="{{ route('classrooms.print-attendance2', $classroom->id) }}" target="_blank">
                  <i class="bi bi-file-pdf me-2 text-danger"></i> Cetak Absen Kedatangan
                </a>
              </li>

              <li>
                <a class="dropdown-item" href="#">
                  <i class="bi bi-file-earmark-text me-2 text-primary"></i> Cetak Rekap Bulanan
                </a>
              </li>
              ...
              <li>
                <a class="dropdown-item" href="{{ route('classrooms.export', $classroom->id) }}">
                  <i class="bi bi-file-earmark-excel me-2 text-success"></i> Ekspor ke Excel
                </a>
              </li>
            </ul>
          </div>
                  ...
                  <div class="modal fade text-start" id="moveModal{{ $student->id }}" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered modal-sm">
                      <div class="modal-content">
                        ...
                        <form action="{{ route('classrooms.moveStudent', ['classroom' => $classroom->id, 'studentId' => $student->id]) }}" method="POST">
                          @csrf
                          @method('PUT')
      ...
      <div class="card border-0 shadow-sm rounded-4 bg-white">
        <div class="card-body">
          ...
          <form action="{{ route('classrooms.addStudent', $classroom->id) }}" method="POST">
            ...
            <button type="submit" class="btn btn-success w-100 fw-bold" {{ $availableStudents->isEmpty() ? 'disabled' : '' }}>
