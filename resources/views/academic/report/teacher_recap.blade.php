        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0">
            <thead class="bg-light">
              <tr>
                <th class="ps-4">No</th>
                <th class="ps-4 text-nowrap">Nama Guru</th> <th class="text-center text-nowrap">Tatap Muka (Jam)</th> <th class="text-center text-nowrap">Badal (Jam)</th> <th class="text-center text-nowrap">Total Mengajar</th> <th class="text-center text-danger text-nowrap">Total Jam Terhitung</th> <th class="text-center">Aksi</th>
              </tr>
            </thead>
            <tbody>
              @foreach ($recap as $index => $row)
                <tr>
                  ...
                  <td class="ps-4 fw-bold text-nowrap">{{ $row['teacher']->name }}</td> <td class="text-center">{{ $row['main_count'] }}</td>
                  ...
                  <td class="text-center text-nowrap"> <a href="{{ route('academic.report.teacher.detail', ['teacher' => $row['teacher']->id, 'month' => $month, 'year' => $year]) }}"
